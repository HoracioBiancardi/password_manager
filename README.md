...
- **Serviços Backend**: `crypto_vault_service`, `db_service`, `task_runner_service`, `log_buffer_service`, `notification_service`.
...
# Iniciar o servidor
python3 -m uvicorn ps_manager.main:app --reload --port 8001
```
